...
The application is running on (https://nooshith.shinyapps.io/shinyapp/)

ui.R, and Server.R Code in my github repository (https://github.com/Nooshith/week4-coursera)
